...
However, this doesn't seem to be the case, and the skill of the featureless model varies regionally, irrespective of the regional dynamics. The only region in our study which would go against this is the North region, where there was noticeable difference in the mean-ozone scatter.

**Why?**



I think this points to the robustness of the model architecture. We can verify this 



I think this would be because the deep encoder layers are less sensitive to features
